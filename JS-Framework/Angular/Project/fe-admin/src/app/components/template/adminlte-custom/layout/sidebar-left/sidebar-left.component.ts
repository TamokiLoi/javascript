import {
    AfterViewInit, ChangeDetectorRef, Component, ElementRef, NgZone, OnDestroy, OnInit, QueryList,
    Renderer2, ViewChild, ViewChildren
} from '@angular/core';
import {
    ActivatedRoute, NavigationEnd, PRIMARY_OUTLET, Router, RouterEvent
} from '@angular/router';
...
export class SidebarLeftComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    */
    ...
    ngAfterViewInit() {
        ...
        this.dialogService.onVisible.subscribe((value) => {
            this.visible = value;
        })

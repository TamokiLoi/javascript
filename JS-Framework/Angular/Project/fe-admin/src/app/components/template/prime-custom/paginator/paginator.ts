...
import {
    ChangeDetectorRef, Component, EventEmitter, Input, NgModule, OnInit, Output, TemplateRef
} from '@angular/core';
...
export class Paginator implements OnInit {
    ...
    setCurrentRecord(state = null) {
        this._currentRecord = 1;
        if (state && state.page > 0) {
            this._currentRecord = (this._rows * state.page) + 1;
        }
    }
}

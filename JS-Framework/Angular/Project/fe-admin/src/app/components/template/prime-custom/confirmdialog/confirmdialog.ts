...
import {
    Component, ContentChild, ElementRef, EventEmitter, Input, NgModule, NgZone, OnDestroy,
    Renderer2, ViewChild
} from '@angular/core';
...
import { FooterDialog, SharedModule } from '../common/shared';
...
export class ConfirmDialog implements OnDestroy {
    ...
    @ContentChild(FooterDialog, { static: false }) footer;
    ...
    close(event: Event) {
        ...
        this.dialogService.checkVisible(false);
    }

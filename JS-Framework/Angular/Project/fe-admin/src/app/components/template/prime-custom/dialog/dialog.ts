...
import {
    Component, ContentChildren, ElementRef, EventEmitter, Input, NgModule, NgZone, OnChanges,
    OnDestroy, Output, QueryList, Renderer2, ViewChild
} from '@angular/core';

import { FooterDialog, Header, SharedModule } from '../common/shared';
    ...
    template: `
        <div #container [ngClass]="{'ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow':true, 'ui-dialog-rtl':rtl,'ui-dialog-draggable':draggable,'ui-dialog-resizable':resizable}"
            ...
            <div #footer class="ui-dialog-footer ui-widget-content" *ngIf="footerFacet && footerFacet.first">
                <ng-content select="p-footer-dialog"></ng-content>
            </div>
...
export class Dialog implements OnChanges, OnDestroy {
    ...
    @ContentChildren(FooterDialog, { descendants: false }) footerFacet: QueryList<Header>;
    ...
    ngOnChanges(changes: any) {
        ...
        if ('visible' in changes) {
            this.dialogService.checkVisible(this.visible);
        }
    }

...
import {
    DropdownModel, MasterDataType, Pagination, ParamsPagination, SortModel
...
@Component({
    selector: 'master-data-type-list',
    templateUrl: './master-data-type-list.component.html',
    styleUrls: ['./master-data-type-list.component.scss']
})

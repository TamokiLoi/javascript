import {
    ...
    Input, NgZone, OnDestroy, Output, Renderer2, ViewChild, ViewContainerRef, ViewRef
} from '@angular/core';
...
export class AlertComponent implements AfterViewInit, OnDestroy {
    ...
    @ViewChild('containerElementRef', { static: true, read: ViewContainerRef }) private containerElementRef: ViewContainerRef;
